...
@section('title','Vehicle Type - Archives | i-Insure')

@section('archives','active')

@section('aquote','active')

@section('avtype','active')
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <button type="button" class="rbutton btn bg-green waves-effect" data-toggle="tooltip" data-placement="left" title="Reactivate this vehicle type" class="btn btn-success btn-xs waves-effect" data-id = "{{ $type->vehicle_type_ID }}">
                                        <i class="material-icons">autorenew</i>
                                    </button>
                                    <button id = "Delete" type="button" class="btn bg-red waves-effect" data-toggle="tooltip" data-placement="left" title="Delete this vehicle type permanently">
    ...
    <script>
        ...
        $('.rbutton').click(function(event){
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/vehicle/type/reactive',
        ...
        $('#reactivate_all').click(function(event){
          event.preventDefault();
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/vehicle/type/areactive',
