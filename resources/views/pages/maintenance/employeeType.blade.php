...
@section('title','Employee Type - Maintenance | i-Insure')

@section('maintenance','active')

@section('emptype','active')
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12">
                                      <div class="form-group form-float">
                                          <div class="form-line">
                                              <textarea id = "EmployeeType_desc" name = "EmployeeType_desc" rows="1" class="form-control no-resize auto-growth"></textarea>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-md-12">
                                       <div class="form-group form-float">
                                           <div class="form-line">
                                               <textarea id = "aEmployeeType_desc" name = "aEmployeeType_desc" rows="1" class="form-control no-resize auto-growth" disabled></textarea>
                                               <label class="form-label">Description </label>
                                           </div>
                                       </div>
                                    </div>
        ...
        $('#delete_many').click(function(event){
          event.preventDefault();
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/maintenance/employee/type/ardelete',
