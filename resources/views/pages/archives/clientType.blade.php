...
@section('title','Client Type - Archives | i-Insure')

@section('archives','active')

@section('abilling','active')

@section('actype','active')
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  @foreach($clienttype as $ctype)
                                    @if($ctype->del_flag == 1)
                                        <tr>
                                            <td><input type="checkbox" id="{{ $ctype->clientType_ID }}" class="filled-in chk-col-green checkCheckbox " data-id = "{{ $ctype->clientType_ID }}"/>
                                            ...
                                            <td>
                                            <button type="button" class="rbutton btn bg-green waves-effect" data-toggle="tooltip" data-placement="left" title="Reactivate this client type" class="btn btn-success btn-xs waves-effect"
                                            data-id = '{{ $ctype->clientType_ID }}'>
                                            <i class="material-icons">autorenew</i>
                                            </button>
                                            <button id = "Delete" type="button" class="btn bg-red waves-effect" data-toggle="tooltip" data-placement="left" title="Delete this client type permanently">
