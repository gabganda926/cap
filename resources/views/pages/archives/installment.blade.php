...
@section('title','Installment Type - Archives | i-Insure')

@section('archives','active')

@section('abilling','active')

@section('ainstype','active')
                                ...
                                <tbody>
                                  ...
                                  @if($install->del_flag == 1)
                                      <tr>
                                          ...
                                          <td>{{$install->installment_desc}}</td>
                                          ...
                                          <td>
                                          <button type="button" class="rbutton btn bg-green waves-effect" data-toggle="tooltip" data-placement="left" title="Reactivate this installment type" class="btn btn-success btn-xs waves-effect" data-id = "{{ $install->installment_ID }}">
                                            <i class="material-icons">autorenew</i>
                                        </button>
                                        <button id = "Delete" type="button" class="btn bg-red waves-effect" data-toggle="tooltip" data-placement="left" title="Delete this installment type permanently">
    ...
    <script>
        ...
        $('.rbutton').click(function(event){
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/installment/type/reactive',
        ...
        $('#reactivate_all').click(function(event){
          event.preventDefault();
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/installment/type/areactive',
