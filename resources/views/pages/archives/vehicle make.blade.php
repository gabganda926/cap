...
@section('title','Vehicle Make - Archives | i-Insure')
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <button type="button" class="rbutton btn bg-green waves-effect" data-toggle="tooltip" data-placement="left" title="Reactivate this sender" class="btn btn-success btn-xs waves-effect" data-id = "{{ $mke->vehicle_make_ID }}">
                                            <i class="material-icons">autorenew</i>
                                        </button>
                                        <button id = "Delete" type="button" class="btn bg-red waves-effect" data-toggle="tooltip" data-placement="left" title="Delete this sender permanently">
    ...
    <script>
        ...
        $('.rbutton').click(function(event){
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/vehicle/make/reactive',
        ...
        $('#reactivate_all').click(function(event){
          event.preventDefault();
              $.ajax({
                  ...
                  type: 'POST',
                  url: '/admin/archives/vehicle/make/areactive',
